...
| 发布占位符空壳 | 18 | ✅ 归档 |
| 过期报告 | 8 | ✅ 归档 |
| 重复prompt文件 | 1 | ✅ v1归档·v2为canonical |
| Notion导出zip | 1 | ✅ 归档 |
| **合计** | **32** | **全部归档** |
...
|------|:--:|:--:|
| 零字节空文件 | 4 | ✅ 归档 |
| publishing空壳(wechat) | 10 | ✅ 归档 |
| publishing空壳(x-threads) | 10 | ✅ 归档 |
| **合计** | **24** | **全部归档** |

### 非重复保留
| 组 | 判定 |
|------|------|
| NIGHT_LOG.md x2 | 内容不同·保留 |
| SKILL.md x2 | 不同skills·保留 |
| 00-07.md x2 | 不同学习路径·保留 |
