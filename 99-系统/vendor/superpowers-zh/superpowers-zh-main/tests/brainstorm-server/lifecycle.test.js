...
const SERVER = path.join(__dirname, '../../skills/brainstorming/99-系统/脚本/server.cjs');
const START = path.join(__dirname, '../../skills/brainstorming/99-系统/脚本/start-server.sh');
const STOP = path.join(__dirname, '../../skills/brainstorming/99-系统/脚本/stop-server.sh');
