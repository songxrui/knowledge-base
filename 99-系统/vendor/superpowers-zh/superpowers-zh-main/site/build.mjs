...
<meta property="og:image" content="${SITE_URL}/08-媒体与产品/素材/app-icon.png">
<meta name="twitter:card" content="summary">
<meta name="twitter:title" content="${esc(title)}">
<meta name="twitter:description" content="${esc(desc)}">
<link rel="icon" href="/08-媒体与产品/素材/app-icon.png">
...
<header class="nav">
  <a class="brand" href="${base}index.html">
    <img src="/08-媒体与产品/素材/superpowers-small.svg" alt="" width="26" height="26">
...
<footer>
  <div class="foot-qr">
    ...
    <div class="qr-row">
      <figure class="qr-card"><img src="/08-媒体与产品/素材/qr-wechat.jpg" alt="${esc(t.qrWechat)}" width="158" loading="lazy"><figcaption>${t.qrWechat}</figcaption></figure>
      <figure class="qr-card"><img src="/08-媒体与产品/素材/qr-douyin.jpg" alt="${esc(t.qrDouyin)}" width="158" loading="lazy"><figcaption>${t.qrDouyin}</figcaption></figure>
    </div>
  </div>
...
<main id="top">
  ...
  <section class="sponsor">
    ...
    <a class="sponsor-card" href="https://www.5cookie.cc/sign-up?aff=Pj7u" target="_blank" rel="noopener">
      <img src="08-媒体与产品/素材/sponsors/5cookie-code.png" alt="5Cookie Code" width="160">
...
function build() {
  ...
  // 带内容 hash 版本号的资源（styles.css?v= / app.js?v=）与 /08-媒体与产品/素材/* 由更具体
