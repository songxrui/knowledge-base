...
- `--bootstrap` flag for first-time setup; `EXCLUDES` patterns anchored to source root; `08-媒体与产品/素材/` excluded.
...
- Moved `lib/brainstorm-server/` → `skills/brainstorming/99-系统/脚本/` per the [agentskills.io](https://agentskills.io) specification
- All `${CLAUDE_PLUGIN_ROOT}/lib/brainstorm-server/` references replaced with relative `99-系统/脚本/` paths
...
**skill-run**
- Moved from 99-系统/脚本/ to skills/using-skills/
...
- `99-系统/脚本/` directory - Now in obra/superpowers-skills/skills/using-skills/
