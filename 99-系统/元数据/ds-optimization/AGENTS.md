...
The sync script (`99-系统/脚本/sync-ecc-to-codex.sh`) uses a Node-based TOML parser to safely merge ECC MCP servers into `~/.codex/config.toml`:
...
脚本: D:\github\python-tools\D4Vinci__Scrapling\99-系统\脚本\crawler_v2.py
...
- 内容产出: `D:\KnowledgeBase\99-系统\alchemist\output\`
