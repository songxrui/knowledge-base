...
Usage:
    python 99-系统/脚本/content_guard_v7.py                           # scan default book-v7 dir
    python 99-系统/脚本/content_guard_v7.py --dir path/to/book         # scan custom dir
    python 99-系统/脚本/content_guard_v7.py --json                     # JSON output for CI
"""
import os
import sys
import json
...
# --- Configuration ---
DEFAULT_DIR = r"D:\KnowledgeBase\08-媒体与产品\媒体\flagship\book-v7"
BANNED_WORDS = [
    "赋能", "抓手", "闭环", "综上所述", "众所周知",
