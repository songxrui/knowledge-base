...
用法:
    python 99-系统/脚本/monthly_log_summary.py                    # 汇总本月
    python 99-系统/脚本/monthly_log_summary.py 2026-05            # 汇总指定月份

输出: 99-系统/日志/reports/monthly-summary-YYYY-MM.md
"""
...
def scan_evidence_trend(start, end, ym_str):
    ...
    evidence_dir = os.path.join(KB, "08-媒体与产品", "媒体", "flagship", "book-v7")
    audit_files = [
...
def scan_publish_count(start, end):
    ...
    stats_csv = os.path.join(KB, "05-内容生产/运营与发布/数据", "数据统计表.csv")
...
- [ ] 若证据质量下降：对照当前 Git diff、来源台账与 content-guard 基线排查回归
- [ ] 若会话数异常低/高：调整工作节奏
