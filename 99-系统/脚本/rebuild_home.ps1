...
$flagshipVersions = (Get-ChildItem "$vault\08-媒体与产品\媒体\flagship" -Directory).Count
...
$versions = Get-ChildItem "$vault\08-媒体与产品\媒体\flagship" -Directory | Sort-Object Name
...
- [[99-系统/日志/reports/|分析报告]]
- [[99-系统/日志/skill-reports/|Skill 评测报告]]
- [[99-系统/日志/heartbeat/|心跳日志]]
