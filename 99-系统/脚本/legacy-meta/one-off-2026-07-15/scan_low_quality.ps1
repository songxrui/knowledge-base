...
$hashes = @{}
$dupes = @()
foreach ($f in (Get-ChildItem $vault -Recurse -Filter "*.md" -File -Exclude "99-系统\日志\*","99-系统\alchemist\*" | Where-Object { $_.Length -gt 50 })) {
...
$standard = @(".codex",".dbs",".obsidian","00_Inbox","01_Projects","02_Areas","03_Resources","90-归档/历史版本","assets","cards","media","notion","scripts","SOURCES","tmp","zettel","_alchemist","_content-system","structured-content","_logs","_meta","选题管理")
