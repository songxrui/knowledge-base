...
with open('D:\\KnowledgeBase\\08-媒体与产品\媒体\\flagship\\book-v7\\FULL_MANUSCRIPT.md', 'r', encoding='utf-8') as f:
    content = f.read()
    lines = content.split('\n')
...
# ========== 写入 ==========
output = '\n'.join(result)
with open('D:\\KnowledgeBase\\08-媒体与产品\媒体\\flagship\\book-v7\\FULL_MANUSCRIPT.md', 'w', encoding='utf-8') as f:
    f.write(output)
