...
本skill基于以下真实工作流优化：
- **内容仓库**: `D:\KnowledgeBase\08-媒体与产品\媒体\` (815篇媒体内容)
- **产出路径**: 深度卡 `D:\KnowledgeBase\04-知识\卡片\` → 长文 `08-媒体与产品\媒体\wechat\` → 适配 `xiaohongshu\` / `zhihu\`
...
```powershell
# 批量诊断公众号文章
Get-ChildItem D:\KnowledgeBase\08-媒体与产品\媒体\wechat -Filter "W*.md" | ForEach-Object { 
