...
# Delete 99-系统/alchemist/01_Projects (all near-identical content copies)
$ap = "$v\99-系统\alchemist\01_Projects"
if (Test-Path $ap) { 
    ...
    Write-Host "Deleted 99-系统/alchemist/01_Projects: $cnt files, ${sz}KB"
}

# Delete 99-系统/alchemist/03_Resources 
$ar = "$v\99-系统\alchemist\03_Resources"
if (Test-Path $ar) {
    Remove-Item $ar -Recurse -Force
    Write-Host "Deleted 99-系统/alchemist/03_Resources"
}
