...
with open(r"D:\KnowledgeBase\99-系统\元数据\skill_gate_scan.json", "r", encoding="utf-8") as f:
    results = json.load(f)
...
with open(r"D:\KnowledgeBase\99-系统\元数据\spot_check_report.md", "w", encoding="utf-8") as f:
    f.write("\n".join(output_lines))

print(f"Spot check complete: {pass_count} PASS / {warn_count} WARN / {fail_count} FAIL")
print(f"Report: D:\\KnowledgeBase\\99-系统\元数据\\spot_check_report.md")
