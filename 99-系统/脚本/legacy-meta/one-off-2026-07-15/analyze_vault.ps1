...
$standardDirs = @("00_Inbox","01_Projects","02_Areas","03_Resources","90-归档/历史版本","media","cards","assets","notion","tmp","zettel","scripts","SOURCES","选题管理","_alchemist","_content-system","structured-content","_logs","_meta",".obsidian",".dbs",".codex")
