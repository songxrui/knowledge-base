...
with open(r"D:\KnowledgeBase\99-系统\alchemist\weread_extracts\v7_enrichment_bookmarks.json", "r", encoding="utf-8") as f:
    extracts = json.load(f)

# Read EVIDENCE_LEDGER
ledger_path = r"D:\KnowledgeBase\08-媒体与产品\媒体\flagship\book-v7\EVIDENCE_LEDGER.md"
try:
...
manuscript_path = r"D:\KnowledgeBase\08-媒体与产品\媒体\flagship\book-v7\FULL_MANUSCRIPT.md"
try:
