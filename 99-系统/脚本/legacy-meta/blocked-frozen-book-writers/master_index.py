...
sections = {
    "v7 答案之书": (r"08-媒体与产品\媒体\flagship\book-v7", [
    ...
    "公众号文章": (r"08-媒体与产品\媒体\wechat_2026-06-07", [
        "316篇结构化文章",
        "零禁用词通过率 100%",
        "30%含书籍引用",
    ]),
    "微信读书提取": (r"99-系统\alchemist\weread_extracts", [
        "Batch1: 32条 (认知觉醒/驱动/成瘾/少有人走的路)",
        "Batch2: 30条 (复利/穷查理/游戏/致富/复利课)",
        "10本书, 68条高亮, 零污染",
    ]),
    "DBS内容系统": (r"structured-content", [
        "1,543标准单元 (QST/CON/OPI/CAS/SOL)",
        "完整JS工具链 (8脚本)",
        "4类关系 + 4类去重规则",
    ]),
    "飞书同步": (None, [
...
| 入口 | 路径 | 说明 |
|------|------|------|
| 📖 全书统稿 | `08-媒体与产品/媒体/flagship/book-v7/FULL_MANUSCRIPT.md` | 答案之书 v7 完整版 |
| 🎬 路演文稿 | `08-媒体与产品/媒体/flagship/book-v7/presentation.html` | 浏览器打开 |
| 📊 健康面板 | `08-媒体与产品/媒体/flagship/book-v7/HEALTH_CHECK.md` | 全量质量审计 |
| ✅ 发布清单 | `08-媒体与产品/媒体/flagship/book-v7/PUBLISH_CHECKLIST.md` | 23项发布前检查 |
