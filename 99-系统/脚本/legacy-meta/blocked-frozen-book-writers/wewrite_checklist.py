...
```powershell
# 全库禁用词扫描
Select-String -Path "D:\\KnowledgeBase\\08-媒体与产品\媒体\\flagship\\book-v7\\*.md" -Pattern "赋能|抓手|闭环|综上所述|众所周知|值得注意的是" -Encoding UTF8
...
"""
out = r"D:\KnowledgeBase\08-媒体与产品\媒体\flagship\book-v7\PUBLISH_CHECKLIST.md"
