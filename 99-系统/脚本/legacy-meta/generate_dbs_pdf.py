# -*- coding: utf-8 -*-
"""Generate PDF for dontbesilent之书"""
import re, os, glob
...
# Combine chapters
base = r'D:\KnowledgeBase\08-媒体与产品\媒体\创作者书稿\dontbesilent之书\chapters'
...
# Insert TOC content after header
toc_start = 6
...
pdf_file = r'D:\KnowledgeBase\08-媒体与产品\媒体\创作者书稿\dontbesilent之书\dontbesilent之书.pdf'
doc = SimpleDocTemplate(pdf_file, pagesize=A4, rightMargin=2.5*cm, leftMargin=2.5*cm, topMargin=2.5*cm, bottomMargin=2.5*cm,
                         title='dontbesilent之书', author='dontbesilent')
