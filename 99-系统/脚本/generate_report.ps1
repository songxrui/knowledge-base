...
> **生成时间**: $now  
> **Vault 路径**: `$vault`  
> **分析工具**: `99-系统/脚本/analyze_vault_v3.ps1`
...
2. **卡片互联**: 深度卡之间可增加 `[[04-知识/卡片/xxx]]` 横向引用
...
- `99-系统/脚本/analyze_vault_v3.ps1` — 全量 vault 分析器（断链/孤点/Hub节点）
- `99-系统/脚本/rebuild_mocs.ps1` — MOC 索引重建工具
- `99-系统/脚本/rebuild_home.ps1` — HOME.md 重建工具
...
[System.IO.File]::WriteAllText("$vault\99-系统\日志\VAULT_ANALYSIS_2026-06-09.md", $report, $utf8Bom)
Write-Host "Report generated: 99-系统\日志\VAULT_ANALYSIS_2026-06-09.md" -ForegroundColor Green
