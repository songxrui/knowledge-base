...
```powershell
# 创建工作目录
mkdir D:\KnowledgeBase\08-媒体与产品\视频\douyin\projects -Force
...
```powershell
# 假设 99-系统/脚本/ 下有 day01.txt, day02.txt, day03.txt
...
文件: `D:\KnowledgeBase\06-运营数据\数据统计表.csv`
