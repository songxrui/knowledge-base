...
python 99-系统/脚本/pre_repair_snapshot.py snapshot

# 证据修复后对比（必须PASS才能继续）
python 99-系统/脚本/pre_repair_snapshot.py compare

# 全库禁用词扫描
Select-String -Path "D:\KnowledgeBase\08-媒体与产品\媒体\flagship\book-v7\*.md" -Pattern "增强|切入点|完整循环|总结|如研究所示|需要注意" -Encoding UTF8

# 证据连接统计
Select-String -Path "D:\KnowledgeBase\08-媒体与产品\媒体\flagship\book-v7\CH*.md" -Pattern "与CH0" -Encoding UTF8
